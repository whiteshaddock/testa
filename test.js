...
window.onload = function () {
    ...
    function loopRev() {
        ...
        // 由于上次loop循环会加1以备下次使用
        // 所以-1才是当前播放图片下标
        // 当轮播图至少需在第一张才能点击-1，若不加判断，连续点击会index负值
        if (index >= 0) index--
    ...
    // // 空
    //  console.log(sessionStorage.getItem('seriesArrOneSto'),4444);
    // console.log(JSON.parse(sessionStorage.getItem('seriesArrOneSto')),4444);
